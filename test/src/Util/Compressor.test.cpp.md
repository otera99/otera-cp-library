...
data:
  ...
  bundledCode: "#line 1 \"test/src/Util/Compressor.test.cpp\"\n// PROBLEM \"https://atcoder.jp/contests/abc036/tasks/abc036_c\"\
    ...
    \ setprecision(20);\n    // INT(t); rep(i, t)solve();\n    solve();\n    return\
    \ 0;\n}\n"
  code: "// PROBLEM \"https://atcoder.jp/contests/abc036/tasks/abc036_c\"\n\n#include<bits/stdc++.h>\n\
    \n#include<otera/Compressor.hpp>\n\nusing namespace std;\n\nusing ll = long long;\n\
...
layout: document
redirect_from:
- /verify/test/src/Util/Compressor.test.cpp
- /verify/test/src/Util/Compressor.test.cpp.html
